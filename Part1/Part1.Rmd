...
Introduce  `bayesplot::mcmc_areas`
Introduce the concepth of ROPE
Introduce `brms::hypothesis`
...
## Solution: adding random term to the model 

```{r, eval = FALSE}
Model3_CJ <- brm(
  Dur_Log ~ 1 + Text_Length + Right_Text + (1|Partic),
  data = Data_CJ2,
  family = "gaussian",
  backend = "cmdstanr",
  seed = 1975
...
- how to tweak the estimation:
  ...
  - set number of chains, iterations
  - set the number of cores to use
  - change the priors (after visualising the priors used)
...
Test: check whether the difference between Left and Right text differs from person to person!
